...
MACRO(SCL_ADDLIB libname srcs libs)
  ...
  IF( (NOT SCL_BUILD_SHARED_LIBS) AND ( NOT SCL_BUILD_STATIC_LIBS ) )
    message( FATAL_ERROR "Error: Not building static OR shared libs?!" ) #prevent much hair-pulling
  ENDIF( (NOT SCL_BUILD_SHARED_LIBS) AND ( NOT SCL_BUILD_STATIC_LIBS ) )
